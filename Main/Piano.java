...
public class Piano extends TimerTask implements JMC {
    ...
    public Piano(SSD1306 oledObject, Pin octavePin, Pin notePin, Pin stopPin) {
    ...
    public void run() {
        ...
        try {
            ...
            if(octavePin.getValue() == 1 && notePin.getValue() == 0 && count != 0) {
                ...
                count = 0;
            } else if(octavePin.getValue() == 1 && count != 8) {
                count = count + 1;
            }
